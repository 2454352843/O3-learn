    ...
    def georef_data(self, out_filepath, in_filepath, vrt, EPSG_code, spatial_res):
        ...
        if not spatial_res:
            if EPSG_code == "4326":
                ...
                # params['xRes'] = 0.00900  # equivalent to 1000 meters
                # params['yRes'] = 0.00900  # equivalent to 1000 meters
...
if __name__ == '__main__':
    ...
    hdf_folder =  r'D:\work\python\data\tif\O3\对流层\test'
    hdf_files = os.listdir(hdf_folder)
    file_paths = []
    for file in hdf_files:
        file_paths.append(hdf_folder + "\\" + file)
    outpath = r'D:\work\python\data\tif\O3\对流层\test\workspace'
