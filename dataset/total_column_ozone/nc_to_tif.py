...
if __name__ == '__main__':
    # Input_folder = "./resource/S5P_OFFL_L2__O3__PR_20211202T033141_20211202T051311_21434_02_020301_20211203T192838.nc"
    # end_name = 'nc'
    # Output_folder = os.path.split(Input_folder)[0] + 'out_' + os.path.split(Input_folder)[-1]
    # inputPath = Input_folder + os.sep + '*' + end_name
    # logger.info(Output_folder)
    # data_list = glob.glob(Input_folder)
    # print("输入位置为: ", Input_folder)
    # print("被读取的nc文件有：", data_list)
    nc_to_tif(".\\resource\\")
