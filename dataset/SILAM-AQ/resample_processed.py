...
def main():
    ...
    inputpath = r"E:\data\3. SILAM\5yuedataset\1clip" + os.path.sep
    outputpath = r"E:\data\3. SILAM\5yuedataset\2reshape" + os.path.sep
    ...
    for i in range(len(tiffiles)):
        ...
        outdir = outputpath + tifile.split('\\')[-2] + os.path.sep
        if not os.path.exists(outdir):
            os.makedirs(outdir)
        outtiffile = outdir + os.path.basename(tifile)[:-4] + "_temp.tif"
        outtif = outdir + os.path.basename(tifile)[:-4] + ".tif"
