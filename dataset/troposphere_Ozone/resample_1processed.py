...
def resample(data,list,outpath):
...
def main():
    worksapce = r'E:\data\1. S5P_OFFL_L2_O3\processed_202205'
    outputpath = r"E:\data\1. S5P_OFFL_L2_O3\5yuedataset"
    for i in range(31):
        i = i + 1
        if i < 10:
            i = '0' + str(i)
        ...
        work_folder = worksapce + os.path.sep + str1
        list = glob.glob(work_folder+os.path.sep +'*.tif')

        # 调用裁剪方法
        resample(str1, list,outputpath )
